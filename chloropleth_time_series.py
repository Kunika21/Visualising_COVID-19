...
import numpy as np
# ----------- Step 1 ------------
URL_DATASET = r'/home/kunika/Desktop/Data_viz/Datathon_3/COVID19/archive/time_series_covid_19_confirmed.csv'
...
if os.path.exists(head + '/Results/chloropleth2'):
    pass
else:
    os.makedirs(head + '/Results/chloropleth2')

results_dir = head + '/Results/chloropleth2/'
