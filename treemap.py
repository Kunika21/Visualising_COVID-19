...
fig = px.treemap(df, path=['Continents','Country/Region', 'Province/State'], values= sys.argv[1],
                  color="Continents", hover_data= ['Province/State'],
...
if os.path.exists(head + '/Results/treemap'):
    pass
else:
    os.makedirs(head + '/Results/treemap')

results_dir = head + '/Results/treemap/'
